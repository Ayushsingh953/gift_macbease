...
export default function ReceiveModal({ setReceive }) {
    ...
    function getRightTick(value) {
        if ((value === 1 && option === 1) || (value === 2 && option === 2)) {
            return (
                <Pressable style={({ pressed }) => [pressed && { opacity: 0.5 }, styles.tickButton, { borderWidth: 3, borderColor: "#2cf185" }]} onPress={() => setOption(null)}>
            ...
            return (
                <View style={styles.modalContainer}>
                    ...
                    <Animatable.View
                        ...
                        useNativeDriver
                    >
                        <LottieView source={require('../assets/83043-gift-box.json')} autoPlay loop style={[{ width: 200, height: 200 }]} />
                    </Animatable.View>
                    ...
                    <Animatable.View
                        ...
                        useNativeDriver
                    >
                        <Pressable style={({ pressed }) => [styles.submit, pressed && { opacity: 0.5 }]} onPress={() => { setModalState(option); exitModal(); }}>
        ...
        if (modalState === 1) {
            return (
                <View style={styles.modalContainer}>
                    ...
                    <LottieView source={require('../assets/96590-astronaut-info.json')} autoPlay loop style={[{ width: 200, height: 200 }]} />
                    <Animatable.View
                        animation={up2}
                        delay={1000}
                        useNativeDriver
                    ...
                    >
                        <Text style={styles.subTitle}>Your locker id is L-1 and password is U-3</Text>
        ...
        if (modalState === 2) {
            return (
                <View style={styles.modalContainer}>
                    ...
                    <LottieView source={require('../assets/88338-crying-baby-astronaut.json')} autoPlay loop style={[{ width: 200, height: 200 }]} />
                    <Animatable.View
                        animation={up2}
                        delay={1000}
                        useNativeDriver
                        style={{ display: "flex", alignItems: "center", justifyContent: "center", marginTop: 12 }}
                    >
                        <Text style={styles.subTitle}>We are so sorry to know you won't be coming.</Text>
    ...
    return (
        <View style={{ height: height, width: width, backgroundColor: "#ffffff9c" }}>
