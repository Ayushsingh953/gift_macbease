...
import { blockList, colors } from "../constants/data";
...
export default function BlockModal({ setBlockModal, blockModal }) {
    ...
    function handleUnblockingEvent() {
        ...
        setTimeout(() => { setModalState("list") }, 6000);
    }
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <View style={styles.unblock}>
                                        ...
                                        <Pressable style={({ pressed }) => [pressed && { opacity: 0.5 }]} onPress={() => { handleUnblockingEvent() }}>
            ...
            return (
                <View style={{ width: 200, height: 200 }}>
                    <Animatable.View
                        ...
                        useNativeDriver
                    >
                        <LottieView source={require("../assets/68792-cute-astronaut-flying-in-space-animation.json")} autoPlay loop style={{ height: 200, width: 200 }} />
                    </Animatable.View>
                    <Animatable.View
                        ...
                        useNativeDriver
                    >
                        <Text style={styles.subText}>It's good to know you are unblocking someone!Hold on while we are unblocking...</Text>
                    </Animatable.View>
                </View>
            )
        }
            ...
            return (
                <View style={{ width: 200, height: 200 }}>
                    <Animatable.View
                        ...
                        useNativeDriver
                    >
                        <LottieView source={require("../assets/91574-astronaut-illustration.json")} autoPlay loop style={{ height: 200, width: 200 }} />
                    </Animatable.View>
                    <Animatable.View
                        style={styles.unblockingText}
                        animation={x}
    ...
    return (
        <View style={styles.modalContainer}>
            <Pressable style={({ pressed }) => [pressed && { opacity: 0.5 }, styles.goBack]} onPress={() => { setBlockModal(false) }}>
